...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mLeftClock, mNetworkTraffic, mInfinitiveLogo;
    ...
    public void init() {
        ...
        mInfinitiveLogo = mView.findViewById(R.id.io_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mInfinitiveLogo, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mInfinitiveLogo.setAlpha(newAlphaBC);
        }
    }
}
